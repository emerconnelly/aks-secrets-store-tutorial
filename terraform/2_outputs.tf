...
# easily inspect the SQL connection string for troubleshooting
...
# open the ProGet web app with the AGIC public IP
...
# replace this value in secrets-provider-class.yaml
